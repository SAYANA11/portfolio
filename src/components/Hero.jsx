...
{
  id: "7",
  title: "Day 7: Free Day Fun & BGC Experience",
  description:
    "On Day 7, the final day of our tour, we were given free time to enjoy the day on our own. We decided to make the most of it by heading to Star City, a popular amusement park in Manila. From thrilling rides to exciting attractions, it was an adrenaline-filled experience. Some of the rides were a bit scary, but that only added to the fun! It was the perfect way to wrap up the adventure before heading home.\n\nAfterward, we went to Bonifacio Global City (BGC), a trendy area known for its modern architecture and vibrant atmosphere. We explored the area, taking pictures of the stunning skyline and unique landmarks. One of the highlights was trying out the electric scooters that were all the rage. It was a fun, new experience as we zipped through the streets, feeling like locals in one of Manila's most dynamic neighborhoods.\n\nThough it was an exciting day, there was also a sense of sadness as we realized the tour was coming to an end. The memories we created during the past week, from the historical sites to the cultural experiences and fun activities, will definitely stay with us. Day 7 was a bittersweet but fun finale to an unforgettable journey.",
